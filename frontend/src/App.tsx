                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm text-muted-foreground">
                      {activeChatMeta
                        ? "Review your selected discussion or continue exploring cricket rulings."
                        : "Ask a question about cricket laws, formats, or tricky match situations."}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="mx-auto max-w-2xl space-y-6">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-2xl font-semibold md:text-3xl">
                        Your cricket rulebook, in chat form
                      </h3>
                      <p className="text-sm text-muted-foreground md:text-base">
                        Use conversational questions to explore match scenarios,
                        confirm rulings, or pull citations from the official
                        cricket laws and playing conditions.
                      </p>
                    </div>
          ...
          <div className="space-y-5">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Quickly clarify cricket rulings, fielding restrictions, and
                on-field scenarios.
              </p>
            </div>
            <Button
